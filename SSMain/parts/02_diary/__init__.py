...
def render():
    ...
    with col2:
        ...
        with st.form("guest_form", clear_on_submit=True):
            user_msg = st.text_area("Leave a note...", height=100, label_visibility="collapsed",
        ...
        msgs = load_guestbook(GUESTBOOK_FILE)
        if msgs:
            for row in reversed(msgs[-8:]):
                st.markdown(f"""
                <div class="guest-msg">
            ...
            st.markdown("<p style='text-align:center; font-style:italic; font-size:0.8em;'>No messages yet.</p>",
                        unsafe_allow_html=True)
